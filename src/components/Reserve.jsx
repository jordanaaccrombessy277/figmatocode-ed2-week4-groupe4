...
import whatsapp_blue from "../assets/whatsapp-blue.svg"
import calendar from "../assets/calendar.svg"

function Reserve() {
  return (
    <div className={`w-full px-6 py-8 md:px-32 bg-blue-extralight flex h-auto items-center flex-col md:flex-row gap-10`}>
         <div className="bg-gradient-to-r from-blue-primary to-purple-primary w-full h-auto rounded-3xl p-6 md:py-16 md:px-32 flex flex-col items-center">
            <p className="font-semibold text-lg md:text-2xl pb-3 text-white text-center pb-2"> Book our services now</p>
            ...
            <div className="flex flex-col md:flex-row gap-6">
               ...
               <a href="/" className="px-4 py-2 md:py-3 items-center text-sm md:text-base rounded-3xl bg-white flex flex-row gap-2">
                  <img src={whatsapp_blue} alt="whatsapp" />
